    ...
    <div class='projects' ref={ref}>
      <div className='project'>
        <div className='descr'>
          ...
          <p>Developed an eccomere website and product designer for Made Rich T-Shirt Printing. This t-shirt designer allows users to upload designs, upload text, and select premade designs to create unique products uncluding hats, t-shirts, hoodies, tanktops, and more. I utilized the Wordpress Platform to create this site which allows my client to manage their eccomerce store and receive custom designs through the Woo-Comerce Plugin CMS.</p>
